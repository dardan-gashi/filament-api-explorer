...
final readonly class SchemaField
{
	 ...
	 * @param  bool  $optional  Left out of a schema that names the rest, which is how a response says a field can be missing entirely — a relation the endpoint does not load, for instance.
